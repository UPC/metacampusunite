...
class announcement {
    ...
    public static $db_table = 'block_announcements';
    public static $component = 'block_announcements';
    public static $file_area = 'announcements';
    ...
    public static function get_values_for_target() {
        $options = array(
            '_blank' => get_string('url_blank', 'block_announcements'),
            '_self' => get_string('url_self', 'block_announcements'),
        );
        return $options;
    }
    ...
    private function insert_object_to_db(){
        ...
        $new_object->icon  = $this->icon;
        $new_object->position  = $this->position;
    ...
    public function validate() {
        ...
        if (!empty($this->url)) {
            if (filter_var($this->url, FILTER_VALIDATE_URL) === FALSE) {
                $errors['url'] = get_string('error_valid_url', 'block_announcements');
            }
        }
        ...
        if (!in_array($this->link_target, $keys)) {
            $errors['link_target'] = get_string('error_link_target', 'block_announcements');
        }
    ...
    /**
     * Get selected roles id for this announcement.
     *
    ...
    /**
     * Get selected alt id for this announcement.
     *
     * @return string comma separated role ids
     */
    ...
    /**
     * Set roles for this announcement.
     *
     * @param array.
     * @return null
     */
    ...
    public function is_visible_for_user_with_roles($userroles){
        ...
        $announcementroles  = explode(',', $this->roles);

        foreach($userroles as $userrole) {
            if (in_array($userrole->roleid, $announcementroles)){
                return true;
            }
        }
