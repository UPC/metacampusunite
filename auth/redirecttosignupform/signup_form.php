...
class redirecttosignupform_signup_form extends moodleform {
        ...
        if ($fields = profile_get_signup_fields()) {
            foreach ($fields as $field) {
                if (!isset($currentcat) || $currentcat != $field->categoryid) {
                    ...
                    $mform->setExpanded('category_'.$field->categoryid);
                }
            }
        }
    ...
    function definition_after_data() {
        ...
        if ($mform->isSubmitted()) {
            $username = clean_param($mform->exportValue('email'), PARAM_EMAIL);
