...
* remove folder theme/metacampus/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/metacampus/scss/bootstrap
...
* comment out this line in theme/metacampus/scss/_print.scss
    @page {
...
* copy the js files from ~/bootstrap/js/src to theme/metacampus/amd/src/bootstrap (including the subfolder)
...
* in folder theme/metacampus run "Grunt amd" to compile the bootstrap JS
