...
/**
 * A two column layout for the metacampus theme.
 *
...
$centerblockshtml = $OUTPUT->blocks('center-post');
$haspostblocks = strpos($postblockshtml, 'data-block=') !== false;
$hascenterblocks = strpos($centerblockshtml, 'data-block=') !== false;
...
$templatecontext = [
    ...
    'centerpostblocks' => $centerblockshtml,
    'hascenterblocks' => $hascenterblocks,
...
echo $OUTPUT->render_from_template('theme_metacampus/columns2', $templatecontext);
